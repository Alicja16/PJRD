...
set(SRCLIST_PIXOPS_H src/xPixelOps.h src/xPixelOpsBase.h src/xPixelOpsSTD.h   src/xPixelOpsSSE.h   src/xPixelOpsAVX.h   src/xPixelOpsAVX512.h    src/xMarginOps.h)
...
set(SRCLIST_PUBLIC  ${SRCLIST_COMMON_H} ${SRCLIST_CONST_H} ${SRCLIST_DIST_H} ${SRCLIST_PIXOPS_H} ${SRCLIST_CLR_H} ${SRCLIST_PIC_H} ${SRCLIST_THREAD_H} ${SRCLIST_IO_H} ${SRCLIST_MATH_H} ${SRCLIST_UTILS_H})
set(SRCLIST_PRIVATE ${SRCLIST_COMMON_C} ${SRCLIST_CONST_C} ${SRCLIST_DIST_C} ${SRCLIST_PIXOPS_C} ${SRCLIST_CLR_C} ${SRCLIST_PIC_C} ${SRCLIST_THREAD_C} ${SRCLIST_IO_C} ${SRCLIST_MATH_C} ${SRCLIST_UTILS_C})
...
source_group(Constexpr  FILES ${SRCLIST_CONST_H}  ${SRCLIST_CONST_C} )
...
source_group(Math       FILES ${SRCLIST_MATH_H}   ${SRCLIST_MATH_C}  )
